...
export const sbtiResults: SbtiResult[] = [
  ...
  },
  {
    ...
    description:
      "당신은 끝없이 생각을 하는 사람이군요! 뿌슝이의 머릿속은 쉬지 않아요. 생각과 망상으로 가득해요. 심리학, 철학, 인문학 등 추상적인 내용을 배우는 과목들을 좋아하기도 해요. 과제가 생기면 계획을 세우고 미리미리 해내는 편이에요. 남에게 피해 주는 걸 싫어해서 팀플에는 열심히 참여해요. 친구들의 이야기를 잘 들어주고 공감을 잘 해주는 건 물론, 통찰력과 배려심이 있어 친구들의 감정이나 속마음을 잘 알아채고 챙겨주려고 노력해요. 주변에게 친절하고 다정다감하지만 뿌슝이의 맘속의 선을 넘는 건 싫어해요. 사람에 대해 관심이 많지만 자기 속내를 잘 드러내지 않는군요. 가끔은 본인의 감정이나 속내를 표현해보는 건 어떨까요?",
